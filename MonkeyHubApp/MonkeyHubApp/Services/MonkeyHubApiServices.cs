...
[assembly: Dependency(typeof(MonkeyHubApp.Services.MonkeyHubApiServices))]
namespace MonkeyHubApp.Services
{
    public class MonkeyHubApiServices : IMonkeyHubApiServices
    {
        public const string BaseUrl = "https://monkey-hub-api.azurewebsites.net/api";
